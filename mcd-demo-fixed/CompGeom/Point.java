...
public class Point extends Object {
    ...
    public double perpdot(Point p) {
        return x * p.y - y * p.x;
    }

    public double dotperp(Point p) {
        return -x * p.y + y * p.x;
    }
    ...
    public double perpdot(Point p, Point q) {
        return x * (q.y - p.y) - y * (q.x - p.x);
    }

    public double dotperp(Point p, Point q) {
        return y * (q.x - p.x) - x * (q.y - p.y);
    }
    ...
    final static public boolean segmentIntersect(Point a, Point b, Point c, Point d) {
