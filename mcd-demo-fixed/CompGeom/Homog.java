...
public final class Homog extends Object {
    ...
    public Homog(Point p) {
        this(1.0, p.x, p.y);
    }

    public Homog(int px, int py) {
        this(1.0, px, -py);
    }

    public Homog(java.awt.Point p) {
        this(p.x, p.y);
    }
    ...
    public boolean equals(Homog q) {
        return (q.w * x == w * q.x) && (q.w * y == w * q.y);
    }
